...
def influential(file,start_frame,num_frames):
    data_file = file
    start_row = start_frame-35
    df = pd.read_csv(data_file, skiprows=int(start_row),nrows=int(num_frames)+30, names=['X1','Y1','H1','X2','Y2','H2','VX1','VY1','VX2','VY2','UVX1','UVY1','UVX2','UVY2'])
    ...
    time_delays = range(tau_0, max_time_delay + 1)  # Create your R_k
    ...
    for t_k in range(len(fish1_velocities) - w):  
        ...
        Gamma_values.append(max_correlation)
