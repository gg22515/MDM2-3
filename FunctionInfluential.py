...
def influential(file,start_frame,num_frames):
    ...
    return Gamma_values[1:] #skips the first value as this is just whatever is set as correlation above so total size will be + -1 + -w*n eg 1000 rows will give you 979 or 800 rows will give you 783
